...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-card border-border hover:border-primary transition-colors">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground mb-1">Orderan Aktif</p>
      ...
      {/* Quick Actions */}
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent>
            <div className="text-center py-8">
              <p className="text-muted-foreground">Belum ada order masuk.</p>
            </div>
          </CardContent>
        </Card>
      </div>
